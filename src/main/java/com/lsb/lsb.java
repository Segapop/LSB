...
public class lsb
{
    ...
    public void EntityAttributes(final EntityAttributeCreationEvent event) {
        ...
        event.put(AddonEntities.SBAMMOLITE.get(), EntitySbAmmolite.registerAttributes().build());
        event.put(AddonEntities.SBCALCITE.get(), EntitySbCalcite.registerAttributes().build());
        event.put(AddonEntities.SBHOLTITE.get(), EntitySbHoltite.registerAttributes().build());
        event.put(AddonEntities.SBCUPRITE.get(), EntitySbCuprite.registerAttributes().build());
    }
