...
public class ConductorAbility extends Ability implements IIdleAbility {

    //Idle abilities are used for abilities like torch bearer, or beastmaster
    public ConductorAbility() {
    ...
    public Component getName() {
        return Component.translatable("ability.lsb.conductor");
    }

    @Override
    public void execute() {
        // Stops potion effects from expiring if Coppers are playing Music
