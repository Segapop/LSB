...
import com.lsb.entity.abilities.SingerAbility;
...
public class EntitySbGold extends EntityVaryingGem {

    //This gem was copied from topaz
    public EntitySbGold(EntityType<? extends PathfinderMob> type, Level worldIn) {
        super(type, worldIn);
    }
    ...
    @Override
    public int generateHairVariant() { return this.random.nextInt(4); }
    ...
    public ArrayList<Ability> definiteAbilities() {
        ArrayList<Ability> arrayList = new ArrayList<>();
        arrayList.add(new SingerAbility());
        return arrayList;
    }
