...
import com.lsb.entity.abilities.CraftingAbility;
import com.lsb.entity.abilities.MeleeAbility;
import com.lsb.entity.abilities.MixedAbility;
...
public class EntityMoissanite extends EntityVaryingGem {

    //This gem was copied from topaz
    public EntityMoissanite(EntityType<? extends PathfinderMob> type, Level worldIn) {
        super(type, worldIn);
    }
    ...
    @Override
    public int generateHairVariant() { return this.random.nextInt(9); }
