...
import com.lsb.entity.abilities.HerderAbility;
import com.lsb.entity.abilities.NightAbility;
...
public class EntitySbMoonstone extends EntityVaryingGem {

    //This gem was copied from topaz
    public EntitySbMoonstone(EntityType<? extends PathfinderMob> type, Level worldIn) {
        super(type, worldIn);
    }
    ...
    @Override
    public Float baseXScale() { return .7F; }
    ...
    public ArrayList<Ability> definiteAbilities() {
        ArrayList<Ability> arrayList = new ArrayList<>();
        arrayList.add(new HerderAbility());
        arrayList.add(new NightAbility());
        return arrayList;
    }
