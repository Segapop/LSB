...
public class EntitySbMoissanite extends EntityVaryingGem {

    //This gem was copied from topaz
    public EntitySbMoissanite(EntityType<? extends PathfinderMob> type, Level worldIn) {
        super(type, worldIn);
    }
    ...
    @Override
    public int generateHairVariant() { return this.random.nextInt(20); }
