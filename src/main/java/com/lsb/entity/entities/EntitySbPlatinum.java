...
import com.lsb.entity.abilities.BackupDancerAbility;
...
public class EntitySbPlatinum extends EntityGem {

    //this gem was copied from ruby

    public EntitySbPlatinum(EntityType<? extends PathfinderMob> type, Level worldIn) {
        super(type, worldIn);
    }
    ...
    public ArrayList<Ability> definiteAbilities(){
        ArrayList<Ability> arrayList = new ArrayList<>();
        arrayList.add(new BackupDancerAbility());
        return arrayList;
    }
