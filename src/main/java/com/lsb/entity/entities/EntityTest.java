...
import com.lsb.lsb;
import com.lsb.entity.abilities.AttributeAbility;
import com.lsb.entity.abilities.IdleAbility;
...
public class EntityTest extends EntityGem {
    ...
    public ArrayList<Ability> definiteAbilities(){
        ArrayList<Ability> arrayList = new ArrayList<>();
        arrayList.add(new IdleAbility());
        arrayList.add(new AttributeAbility());
        return arrayList;
    }
