package com.lsb.client.entity.model;// Made with Blockbench 4.6.5
...
public class ModelVaryTest<T extends EntityGem> extends ModelGem<T> {
	...
	public ModelVaryTest(ModelPart root) {
