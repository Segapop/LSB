...
public class RenderSbAmmolite extends MobRenderer<EntitySbAmmolite, ModelNephrite<EntitySbAmmolite>> {
    ...
    @Override
    protected void scale(EntitySbAmmolite entitylivingbaseIn, PoseStack matrixStackIn, float partialTickTime) {
        matrixStackIn.scale(entitylivingbaseIn.getXScale(), entitylivingbaseIn.getYScale(), entitylivingbaseIn.getZScale());
        super.scale(entitylivingbaseIn, matrixStackIn, partialTickTime);
    }

    @Override
    public ResourceLocation getTextureLocation(EntitySbAmmolite entity) {
        return new ResourceLocation(lsb.MODID+":textures/entity/sbammolite/blank.png");
    }
    @Override
    protected void renderNameTag(EntitySbAmmolite entityIn, Component displayNameIn, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
