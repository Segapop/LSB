...
public class RenderSbPentagonite extends MobRenderer<EntitySbPentagonite, ModelNephrite<EntitySbPentagonite>> {
    ...
    @Override
    protected void scale(EntitySbPentagonite entitylivingbaseIn, PoseStack matrixStackIn, float partialTickTime) {
        matrixStackIn.scale(entitylivingbaseIn.getXScale(), entitylivingbaseIn.getYScale(), entitylivingbaseIn.getZScale());
        super.scale(entitylivingbaseIn, matrixStackIn, partialTickTime);
    }

    @Override
    public ResourceLocation getTextureLocation(EntitySbPentagonite entity) {
        return new ResourceLocation(lsb.MODID+":textures/entity/sbpentagonite/blank.png");
    }
    @Override
    protected void renderNameTag(EntitySbPentagonite entityIn, Component displayNameIn, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
