...
public class RenderSbOpal extends MobRenderer<EntitySbOpal, ModelSbOpal<EntitySbOpal>> {

    public RenderSbOpal(EntityRendererProvider.Context renderManagerIn, ModelSbOpal<EntitySbOpal> baseModel) {
    ...
    @Override
    protected void scale(EntitySbOpal entitylivingbaseIn, PoseStack matrixStackIn, float partialTickTime) {
        matrixStackIn.scale(entitylivingbaseIn.getXScale(), entitylivingbaseIn.getYScale(), entitylivingbaseIn.getZScale());
        super.scale(entitylivingbaseIn, matrixStackIn, partialTickTime);
    }

    @Override
    public ResourceLocation getTextureLocation(EntitySbOpal entity) {
        return new ResourceLocation(lsb.MODID+":textures/entity/sbopal/blank.png");
    }
    @Override
    protected void renderNameTag(EntitySbOpal entityIn, Component displayNameIn, PoseStack matrixStackIn, MultiBufferSource bufferIn, int packedLightIn) {
