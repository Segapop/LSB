...
public class AddonEntities {
    ...
    public static final RegistryObject<EntityType<EntitySbAmmolite>> SBAMMOLITE = ENTITIES.register("sbammolite",
            () -> EntityType.Builder.of(EntitySbAmmolite::new, MobCategory.CREATURE)
                    .sized(.75f, 2f)
                    .build(new ResourceLocation(lsb.MODID, "sbammolite").toString()));

    public static final RegistryObject<EntityType<EntitySbCalcite>> SBCALCITE = ENTITIES.register("sbcalcite",
            () -> EntityType.Builder.of(EntitySbCalcite::new, MobCategory.CREATURE)
                    .sized(.75f, 3f)
                    .build(new ResourceLocation(lsb.MODID, "sbcalcite").toString()));


    public static final RegistryObject<EntityType<EntitySbHoltite>> SBHOLTITE = ENTITIES.register("sbholtite",
            () -> EntityType.Builder.of(EntitySbHoltite::new, MobCategory.CREATURE)
                    .sized(.75f, 2f)
                    .build(new ResourceLocation(lsb.MODID, "sbholtite").toString()));


    public static final RegistryObject<EntityType<EntitySbCuprite>> SBCUPRITE = ENTITIES.register("sbcuprite",
            () -> EntityType.Builder.of(EntitySbCuprite::new, MobCategory.CREATURE)
                    .sized(.75f, 2f)
                    .build(new ResourceLocation(lsb.MODID, "sbcuprite").toString()));
    ...
    public static void registerCruxes() {
        ...
        ModEntities.CRUXTOGEM.put("sbammolite", AddonCruxes.SBAMMOLITE_CONDITIONS());
        ModEntities.CRUXTOGEM.put("sbcalcite", AddonCruxes.SBCALCITE_CONDITIONS());
        ModEntities.CRUXTOGEM.put("sbholtite", AddonCruxes.SBHOLTITE_CONDITIONS());
        ModEntities.CRUXTOGEM.put("sbcuprite", AddonCruxes.SBCUPRITE_CONDITIONS());
    ...
    public static void setAddonGems(){
        ...
        AddonHandler.ENTITY_ADDON_ENTITY_REGISTRIES.put("sbammolite", AddonEntities.class);
        AddonHandler.ENTITY_ADDON_ENTITY_REGISTRIES.put("sbcalcite", AddonEntities.class);
        AddonHandler.ENTITY_ADDON_ENTITY_REGISTRIES.put("sbholtite", AddonEntities.class);
        AddonHandler.ENTITY_ADDON_ENTITY_REGISTRIES.put("sbcuprite", AddonEntities.class);
